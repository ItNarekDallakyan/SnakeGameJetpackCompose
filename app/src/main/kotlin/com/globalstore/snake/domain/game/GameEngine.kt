package com.globalstore.snake.domain.game
...
class GameEngine(
    ...
    private var needToPause: Boolean = false
    fun needToPause(needToPause: Boolean) {
        Log.i("sdcsdfcsdfcvdfcv--->>","needToPause $needToPause")
